...
var contact_model_1 = require('../../lib/models/contact.model');
var ContactDetailsComponent = (function () {
    function ContactDetailsComponent() {
    }
    __decorate([
        core_1.Input(), 
        __metadata('design:type', contact_model_1.ContactModel)
    ], ContactDetailsComponent.prototype, "contactDetails", void 0);
